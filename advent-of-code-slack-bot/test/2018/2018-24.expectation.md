*:calendar::calendar:--- Day 24: Immune System Simulator 20XX ---:calendar::calendar:*
...
The *immune system* and the *infection* each have _(On second thought, it's pretty similar to regular reindeer immune systems. =>)_ an army made up of several *groups*; each *group* consists of one or more identical *units*.  The armies repeatedly *fight* until only one army has units remaining.
